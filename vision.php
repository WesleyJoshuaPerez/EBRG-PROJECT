...
if (isset($_GET['action']) && $_GET['action'] === 'delete_account') {
    ...
    header("Location: vision.php"); // Redirect back to avoid re-triggering the deletion
    exit();
}
?>
<!DOCTYPE html>
    ...
    <body>
            ...
            <nav id="nav-menu" class="nav_menu">
                ...
                <div id="Langtrans">
                    ...
                    <li><a href="index.php">Log Out</a></li>
                     <!-- Delete Account Link -->
            <li><a href="vision.php?action=delete_account" id="changeaccount_status">Delete Account</a></li>
                </ul>
            </nav>
            <div class="nav_logo">
        ...
        <div class="container">     
            <h5>To provide sustainable, informative, systematic, and relevant
                ...
                active engagement among all registered residents 
            </h5>
        </div>
    
             <!-- Link to the JavaScript file for darmmode function -->
